...
public class PixelmonMorpher {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "pixelmonmorpher" namespace
    ...
    public PixelmonMorpher(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (PixelmonMorpher) to respond directly to events.
    ...
    public void onServerStarting(ServerStartingEvent event) {
        ...
        LOGGER.info("Registered PokeMorph commands");
    }
}
